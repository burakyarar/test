...
public class C02_TreeMapMethodlari {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(harfler.ceilingEntry("N")); // T=5

        System.out.println(harfler.floorKey("K")); // K
        System.out.println(harfler.floorKey("M")); // L

        System.out.println(harfler.lowerKey("K")); // A

        System.out.println(harfler.pollFirstEntry()); // A=15 (sildi ve bize dondurdu)
