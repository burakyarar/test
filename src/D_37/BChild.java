...
public class BChild extends AParent{
    ...
    private void privateMethod() {
        ...
        // child class kendisinde olusturulan bu method'u
        // parent class'da olmayan bir yeni method kabul eder
    ...
    public static void main(String[] args) {
        ...
        // sayi = 20; final variable son degerini almis demektir
        // dolayisiyla yeni deger atanamaz
